...
def rotate_object_90_degrees_x():
    obj = bpy.context.active_object
    if obj:
        bpy.ops.transform.rotate(value=1.5708, orient_axis='X', orient_type='GLOBAL', 
                                 constraint_axis=(True, False, False))
        logging.info(f"Rotated object {obj.name} by 90 degrees around X-axis")
    else:
        logging.warning("No active object to rotate")
...
def main():
    ...
    # Rotate object 90 degrees around X-axis
    logging.info("Rotating object 90 degrees around X-axis")
    rotate_object_90_degrees_x()
